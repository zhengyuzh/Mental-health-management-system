package com.mentalhealth.project.system.menu.controller;
...
import com.mentalhealth.common.utils.security.AuthorizationUtils;
...
import com.mentalhealth.project.system.menu.domain.Menu;
...
public class MenuController extends BaseController
{
    ...
    public String add(@PathVariable("parentId") Long parentId, ModelMap mmap)
    {
        ...
        if (0L != parentId)
        {
            ...
            System.out.println(" menu = menuService.selectMenuById(parentId);"+menu);
        }
        else
        {
            menu = new Menu();
