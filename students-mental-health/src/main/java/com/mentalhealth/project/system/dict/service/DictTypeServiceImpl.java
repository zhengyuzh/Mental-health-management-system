package com.mentalhealth.project.system.dict.service;
...
import com.mentalhealth.project.system.dict.domain.DictData;
import com.mentalhealth.project.system.dict.domain.DictType;
import com.mentalhealth.project.system.dict.mapper.DictDataMapper;
import com.mentalhealth.project.system.dict.mapper.DictTypeMapper;
...
public class DictTypeServiceImpl implements IDictTypeService
{
    ...
    {
        Long[] dictIds = Convert.toLongArray(ids);  //转换为长数组
        for (Long dictId : dictIds)  //循环遍历 dictIds数组 赋予dictId
        {
            ...
            DictUtils.removeDictCache(dictType.getDictType());  //清除缓存
        }
    }
